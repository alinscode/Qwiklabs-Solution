### Remove and Paste the following code in user file :- 
...
### Remove and Paste the following code in order_items file :- 
...
view: order_items {
  ...
  ```
Save Changes > Validate > Commit > Deploy

### Check progress for all Task
