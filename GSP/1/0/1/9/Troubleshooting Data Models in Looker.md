...
## Develop > qwiklab-ecommerce 
Create view named: `user_order_lifetime`
...
## Check Progress for Task 1, 2 and 4

### For Task 3
Explore > Order item > Click on created table
Make the following changes

- Change to Descending
- Set row limit to 10
- Select <b>Table</b> in Visualization Bar

Gear > Save as Look
Title: `Top 10 Users With Highest Average Sales`
Click Save and view